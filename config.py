...
# Scraper settings
# Override via env vars if needed: POSTS_PER_SUBREDDIT=500 TIME_FILTER=year python run.py
import os as _os
POSTS_PER_SUBREDDIT = int(_os.environ.get("POSTS_PER_SUBREDDIT", 100))
SORT = "top"
TIME_FILTER = _os.environ.get("TIME_FILTER", "week")
